...
assert.ok(source.includes("endpoint: 'inventory.list'"), 'inventory performance instrumentation missing');
assert.ok(source.includes("endpoint: 'builder-projects.list'"), 'builder project performance instrumentation missing');
